<script lang="ts">
	...
	import { brutalistColors, getColor, getColorHex } from '$lib/utils/colors';
	...
	import { StarSolid, CheckCircleSolid, ExclamationCircleSolid } from 'flowbite-svelte-icons';
	import SkillBadge from '$lib/Compound/SkillBadge.svelte';
    import { 
        CodeBranchSolid,
        BrainSolid,
        PenSolid,
